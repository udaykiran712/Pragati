odoo.define('pos_prescription.PrescriptionOrderManagementControlPanel', function (require) {
    'use strict';
     ...
     * @emits search
     */
    class PrescriptionOrderManagementControlPanel extends PosComponent {
        setup() {
            super.setup();
            ...
            PrescriptionOrderFetcher.setSearchDomain(this._computeDomain());
        }
        ...
        get showPageControls() {
            return PrescriptionOrderFetcher.lastPage > 1;
        }
        get pageNumber() {
            const currentPage = PrescriptionOrderFetcher.currentPage;
            const lastPage = PrescriptionOrderFetcher.lastPage;
         ...
         */
        _computeDomain() {
            let domain = [['state', '=', 'prescription'],['acs_pos_processed', '=', false]];
    ...
    PrescriptionOrderManagementControlPanel.template = 'PrescriptionOrderManagementControlPanel';

    Registries.Component.add(PrescriptionOrderManagementControlPanel);

    return PrescriptionOrderManagementControlPanel;
});
