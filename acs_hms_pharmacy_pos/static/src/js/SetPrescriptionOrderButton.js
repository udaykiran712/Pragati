odoo.define('pos_prescription.SetPrescriptionOrderButton', function(require) {
    'use strict';
    ...
    class SetPrescriptionOrderButton extends PosComponent {
        setup() {
            super.setup();
        ...
        async onClick() {
          try {
              ...
              const screen = this.env.isMobile ? 'MobilePrescriptionOrderManagementScreen' : 'PrescriptionOrderManagementScreen';
    ...
    SetPrescriptionOrderButton.template = 'SetPrescriptionOrderButton';

    ProductScreen.addControlButton({
        component: SetPrescriptionOrderButton,
        condition: function() {
            return true;
        },
    });

    Registries.Component.add(SetPrescriptionOrderButton);

    return SetPrescriptionOrderButton;
});
