...
export class AlmightyHmsGraphField extends Component {
    setup() {
        this.chart = null;
...
AlmightyHmsGraphField.template = "acs_hms.AlmightyHmsGraphField";
AlmightyHmsGraphField.props = {
    ...standardFieldProps,
    xlabel: String,
    ylabel: String,
};

AlmightyHmsGraphField.supportedTypes = ["text"];

AlmightyHmsGraphField.extractProps = ({ attrs }) => {
    return {
        xlabel: attrs.xlabel,
        ylabel: attrs.ylabel,
    };
...
registry.category("fields").add("AlmightyHmsGraph", AlmightyHmsGraphField);
