...
#╚══════════════════════════════════════════════════════════════════════╝
{
    ...
    'description': """
        Patient Insurance Management for Laboratory and related Claims. Hospital Management with Insurance Claim. ACS HMS
    """,
    'category': 'Industry',
    'version': '1.0.4',
    ...
    'license': 'OPL-1',
    'depends': ['acs_hms_laboratory', 'acs_hms_insurance'],
    'data': [
